...
Phase I proves every manuscript-owned step in Lean down to exact verified
published literature statements. Phase II discharges those statements from
Mathlib. Neither phase has started; await the user's Phase I kickoff.
A conditional terminal theorem does not settle the Millennium problem.
...
Keep this repository and `../navier-paper` private. No contact with others,
public release, submission, or invented authorship. Literature consists of
source metadata and original notes, not third-party PDFs. Do not commit
generated PDFs, TeX auxiliaries, caches, or credentials. Preserve unrelated
edits, stage explicit paths, and push verified checkpoints regularly.
