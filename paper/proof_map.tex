...
\clearpage
\raggedright
Graph SHA-256: \texttt{aea55e4ab12c01eddfc682c602fb9057}\texttt{64afd1b04fc4bcb5755f375fb16fc25d}.
...
\textbf{Class:} PAPER. \textbf{Formal:} Partial: the PDE and norm-scaling halves are Phase II; eq:L4L3 remains open.
...
\textbf{Class:} PAPER. \textbf{Formal:} Phase II complete: NavierFormal.CP1.scalar\_obstruction\_exists.
...
\textbf{Class:} PAPER. \textbf{Formal:} Phase I under explicit hypotheses: NavierFormal.endpointContinuation\_of\_ess; ESS remains a literature axiom.
...
\textbf{Class:} PAPER / CONDITIONAL. \textbf{Formal:} Phase I conditional theorem: NavierFormal.conditional\_clay\_A\_of\_tao, over the named local-theory and endpoint-continuation literature axioms.
...
\textbf{Class:} GAP. \textbf{Formal:} Open: no unconditional Lean producer; the critical estimate remains unproved.
...
\clearpage\section*{Review-pending component: Strong natural response and corotational material action}
\textbf{Not a promoted claim or an arbitrary-data producer.}
