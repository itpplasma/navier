...
# Exact value recomputed from the current c=1/20, a=9/20, b=3/20 cage.
# (The preceding hard-coded value came from an earlier geometry and made the
# checker fail despite the qualitative theorem remaining true.)
expected=(
    -10170*s.sqrt(11629)-234*s.sqrt(5872645)-162*s.sqrt(5265130)
    -2295*s.sqrt(10426)+135*s.sqrt(1511770)+90*s.sqrt(30537754)
    +3978*s.sqrt(40501)+18306*s.sqrt(2005)
)/s.Integer(13032500)
